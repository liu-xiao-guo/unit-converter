...
UBUNTU_TRANSLATION_DOMAIN="unit-converter.liu-xiao-guo"
...
aptest.commands = bash $$PWD/unit-converter/tests/autopilot/run
aptest.depends  = sub-unit-converter

unittest.target   = check
unittest.commands = /usr/bin/qmltestrunner -input $$PWD/unit-converter/tests/unit 
unittest.depends  = sub-unit-converter
